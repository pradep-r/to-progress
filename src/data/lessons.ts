        ...
        options: [
          {
            value: "no",
            meaning:
              "This is known cat. You have already mentioned it or both you and listener know which cat.",
          },
          {
            value: "yes",
            meaning:
              "You are seeing this cat for the first time. It is not known to the listener.",
          },
        ],
      },
    ],
